...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        #self.clean.append((int(pos.getX()),int(pos.getY())))
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        #raise NotImplementedError
        #[i for i, v in enumerate(self.clean) if v[0] == m and v[1]==n]
        for v in self.clean:
            if v[0]==m and v[1]==n:
                return True
        return False
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        #raise NotImplementedError
        if pos.getX()<self.width and pos.getX() and pos.getX()>=0  and pos.getY()<self.height and pos.getY()>=0  :
            return True
        else:
            return False
